...
CNumber CNumber::operator+(const CNumber& other)
{
    ...
    {
        const CNumber* bigger = nullptr;
        const CNumber* smaller = nullptr;
...
CNumber CNumber::operator/(CNumber& other)
{
    ...
    CNumber result, absoluteValueOfOther;
    ...
    CNumber temp, previousTemp, multiplier;
...
int CNumber::compareTo(const CNumber& other)
{
    if (size > other.size)
    {
        return 1;
...
void CNumber::decreaseSize(CNumber& object)
{
